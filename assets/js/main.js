...
// let idsiERNSHolanlar = results.filter(item => item.order.customerId == "ERNSH");
// console.log(idsiERNSHolanlar.length);
...
//1.usul
// let a=results.findIndex(checkID);
//   function checkID(ID) {
//     return ID == 11075;
// }
// console.log(a);
...
// 2.usul
// let Id = 11075;
// let Index = results.findIndex(item => item.order.id === Id);
// if (Index !== -1) {
//   let findItem = results[Index];
//   console.log(findItem);
// } else {
//   console.log("Bu id-li element yoxdur.");
// }
